...
def lt():
    f5=Frame()
    f5.place(x="0",y="0",width="700",height="566")
    Label(f5, image=bg).place(x="0",y="0",relwidth="1",relheight="1")
    lb8=Label(f5,text="Language Translator",font="comicsansms 30 bold",fg="lightblue")
    lb8.grid(padx="75")
    lb8=Label(f5,text="Under Development",font="comicsansms 20 bold",fg="lightgreen")
    lb8.grid(padx="75",pady="50")
    bt52=Button(f5,text="Go Back",width=12,command=mainpage)
    bt52.grid(ipadx=2,pady=10)
...
def mainpage():
    ...
    l6.grid(padx="35")
    bt2=Button(f1,text="Open",command=lt,font=("comicsansms","10"))
